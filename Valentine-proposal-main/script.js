function showMessage(response) {
  ...
  if (response === "No") {
    ...
    document.getElementById("question").textContent =
      "PRETTY PLEASE, I'LL DIE WITHOUT YOU, ATLEAST THINK ABOUT OREO, HE NEEDS A DAD";
  ...
  if (response === "Yes") {
    ...
    audioElement.src = "./tu zaroori.mp4"; // Source of the sound
    ...
    yesMessage.textContent = "See you on 4th february my princess UAHAHAHAHAHA (Mimansa Salhotra, just like Oxygen is imperative for my lungs, you are for my heart. It beats faster every time you come closer) ";
    yesMessage.style.display = "block";
    yesMessage.style.fontStyle = "normal";
    document.getElementsByClassName("image")[0].src = "images/hugs.gif";
